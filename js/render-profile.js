(function () {
  ...
  Renderer.prototype.drawProfilePanel = function (ctx) {
      ...
      ctx.font = this.fitFont(ctx, playerName, '800', compact ? 24 : 28, 16, w - 72);
      ctx.fillText(playerName, x + w / 2, y + (compact ? 52 : 62));

      ctx.fillStyle = '#ffe590';
      ctx.font = this.fitFont(ctx, rankInfo.title, '800', compact ? 18 : 21, 13, w - 58);
      ...
      ctx.font = '800 ' + (compact ? 14 : 15) + 'px CrystalUI, Arial';
      ...
      ctx.shadowBlur = this.shadow(10);
      ctx.font = this.fitFont(ctx, xpText, '800', compact ? 34 : 40, 24, w - 54);
